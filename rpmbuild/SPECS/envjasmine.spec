...
installed and run against any code on the box. Requires rhino and OpenJDK-7.
...
install -m 0755 -d $RPM_BUILD_ROOT/opt/envjasmine/bin
...
touch $RPM_BUILD_ROOT/opt/envjasmine/conf.js
chmod 666 $RPM_BUILD_ROOT/opt/envjasmine/conf.js
...
%post
echo " "
echo "Acually have installed codes"
%files
%dir /opt/envjasmine
/opt/envjasmine
